...
constexpr int MAX_WEIGHT_URAM_ROW = MAX_WT_X * MAX_WT_Y / WEIGHT_NUM_PER_ROW_URAM;
...
constexpr int MAX_IFC_ENTRY = (MAX_WT_X * MAX_WT_Y * WEIGHTS_DATAWIDTH + IACTS_DATAWIDTH * X * Y) / HP_IFC_BANDWIDTH;
