set moduleName DPEComputation_Pipeline_VITIS_LOOP_303_4
set isTopModule 0
...
set C_modelName {DPEComputation_Pipeline_VITIS_LOOP_303_4}
set C_modelType { void 0 }
set C_modelArgList {
	{ add_ln305 int 10 regular  }
	{ buffer_out int 32 regular {array 1000 { 0 3 } 0 1 }  }
	{ local_output_buf_V int 32 regular {array 640 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "add_ln305", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
 	{ "Name" : "buffer_out", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "local_output_buf_V", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ add_ln305 sc_in sc_lv 10 signal 0 } 
	...
	{ local_output_buf_V_q0 sc_in sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln305", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "add_ln305", "role": "default" }} , 
...
set Spec2ImplPortList { 
	add_ln305 { ap_none {  { add_ln305 in_data 0 10 } } }
	buffer_out { ap_memory {  { buffer_out_address0 mem_address 1 10 }  { buffer_out_ce0 mem_ce 1 1 }  { buffer_out_we0 mem_we 1 1 }  { buffer_out_d0 mem_din 1 32 } } }
	local_output_buf_V { ap_memory {  { local_output_buf_V_address0 mem_address 1 10 }  { local_output_buf_V_ce0 mem_ce 1 1 }  { local_output_buf_V_q0 mem_dout 0 32 } } }
}
