...
`define AUTOTB_TVIN_ifc1  "./c.LINEAR.autotvin_ifc1.dat"
`define AUTOTB_TVIN_ifc2  "./c.LINEAR.autotvin_ifc2.dat"
`define AUTOTB_TVIN_ifc3  "./c.LINEAR.autotvin_ifc3.dat"
`define AUTOTB_TVIN_ifc4  "./c.LINEAR.autotvin_ifc4.dat"
`define AUTOTB_TVIN_ifc5  "./c.LINEAR.autotvin_ifc5.dat"
`define AUTOTB_TVIN_ifc6  "./c.LINEAR.autotvin_ifc6.dat"
`define AUTOTB_TVIN_ifc1_offset  "./c.LINEAR.autotvin_ifc1_offset.dat"
`define AUTOTB_TVIN_ifc2_offset  "./c.LINEAR.autotvin_ifc2_offset.dat"
`define AUTOTB_TVIN_ifc3_offset  "./c.LINEAR.autotvin_ifc3_offset.dat"
`define AUTOTB_TVIN_ifc4_offset  "./c.LINEAR.autotvin_ifc4_offset.dat"
`define AUTOTB_TVIN_ifc5_offset  "./c.LINEAR.autotvin_ifc5_offset.dat"
`define AUTOTB_TVIN_ifc6_offset  "./c.LINEAR.autotvin_ifc6_offset.dat"
`define AUTOTB_TVIN_ifc7  "./c.LINEAR.autotvin_ifc7.dat"
`define AUTOTB_TVIN_X  "./c.LINEAR.autotvin_X.dat"
`define AUTOTB_TVIN_Y  "./c.LINEAR.autotvin_Y.dat"
`define AUTOTB_TVIN_Wt_X  "./c.LINEAR.autotvin_Wt_X.dat"
`define AUTOTB_TVIN_Wt_Y  "./c.LINEAR.autotvin_Wt_Y.dat"
`define AUTOTB_TVIN_ifc1_out_wrapc  "./rtl.LINEAR.autotvin_ifc1.dat"
`define AUTOTB_TVIN_ifc2_out_wrapc  "./rtl.LINEAR.autotvin_ifc2.dat"
`define AUTOTB_TVIN_ifc3_out_wrapc  "./rtl.LINEAR.autotvin_ifc3.dat"
`define AUTOTB_TVIN_ifc4_out_wrapc  "./rtl.LINEAR.autotvin_ifc4.dat"
`define AUTOTB_TVIN_ifc5_out_wrapc  "./rtl.LINEAR.autotvin_ifc5.dat"
`define AUTOTB_TVIN_ifc6_out_wrapc  "./rtl.LINEAR.autotvin_ifc6.dat"
`define AUTOTB_TVIN_ifc1_offset_out_wrapc  "./rtl.LINEAR.autotvin_ifc1_offset.dat"
`define AUTOTB_TVIN_ifc2_offset_out_wrapc  "./rtl.LINEAR.autotvin_ifc2_offset.dat"
`define AUTOTB_TVIN_ifc3_offset_out_wrapc  "./rtl.LINEAR.autotvin_ifc3_offset.dat"
`define AUTOTB_TVIN_ifc4_offset_out_wrapc  "./rtl.LINEAR.autotvin_ifc4_offset.dat"
`define AUTOTB_TVIN_ifc5_offset_out_wrapc  "./rtl.LINEAR.autotvin_ifc5_offset.dat"
`define AUTOTB_TVIN_ifc6_offset_out_wrapc  "./rtl.LINEAR.autotvin_ifc6_offset.dat"
`define AUTOTB_TVIN_ifc7_out_wrapc  "./rtl.LINEAR.autotvin_ifc7.dat"
`define AUTOTB_TVIN_X_out_wrapc  "./rtl.LINEAR.autotvin_X.dat"
`define AUTOTB_TVIN_Y_out_wrapc  "./rtl.LINEAR.autotvin_Y.dat"
`define AUTOTB_TVIN_Wt_X_out_wrapc  "./rtl.LINEAR.autotvin_Wt_X.dat"
`define AUTOTB_TVIN_Wt_Y_out_wrapc  "./rtl.LINEAR.autotvin_Wt_Y.dat"
`define AUTOTB_TVOUT_ifc1  "./c.LINEAR.autotvout_ifc1.dat"
`define AUTOTB_TVOUT_ifc1_out_wrapc  "./impl_rtl.LINEAR.autotvout_ifc1.dat"
module `AUTOTB_TOP;
