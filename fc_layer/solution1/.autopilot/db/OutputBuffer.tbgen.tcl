...
set C_modelArgMapList {[ 
	{ "Name" : "ifc1", "interface" : "axi_master", "bitwidth" : 128, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "ifc1_offset","offset": { "type": "dynamic","port_name": "ifc1_offset"},"direction": "READONLY"},{"cName": "ifc7","offset": { "type": "dynamic","port_name": "ifc7","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "Wt_Y", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ X_dout sc_in sc_lv 32 signal 2 } 
	{ X_empty_n sc_in sc_logic 1 signal 2 } 
	{ X_read sc_out sc_logic 1 signal 2 } 
	{ Wt_Y_dout sc_in sc_lv 32 signal 3 } 
	{ Wt_Y_empty_n sc_in sc_logic 1 signal 3 } 
	{ Wt_Y_read sc_out sc_logic 1 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "Wt_Y_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "Wt_Y", "role": "dout" }} , 
 	{ "name": "Wt_Y_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "Wt_Y", "role": "empty_n" }} , 
 	{ "name": "Wt_Y_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "Wt_Y", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3"],
		...
		"Port" : [
			{"Name" : "ifc1", "Type" : "MAXI", "Direction" : "O",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_OutputBuffer_Pipeline_VITIS_LOOP_329_1_fu_85", "Port" : "ifc1", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
			{"Name" : "p_read", "Type" : "None", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "3", "DependentChanType" : "1"},
			{"Name" : "X", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "X_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "Wt_Y", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "Wt_Y_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "output_buf", "Type" : "Memory", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_OutputBuffer_Pipeline_VITIS_LOOP_329_1_fu_85", "Port" : "output_buf", "Inst_start_state" : "4", "Inst_end_state" : "5"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_OutputBuffer_Pipeline_VITIS_LOOP_329_1_fu_85", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_OutputBuffer_Pipeline_VITIS_LOOP_329_1_fu_85.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_32_1_1_U634", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	Wt_Y { ap_fifo {  { Wt_Y_dout fifo_data 0 32 }  { Wt_Y_empty_n fifo_status 0 1 }  { Wt_Y_read fifo_update 1 1 } } }
