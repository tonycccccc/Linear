...
//------------------------Parameter----------------------
`define TV_IN_ifc6 "../tv/cdatafile/c.LINEAR.autotvin_ifc6.dat"
`define TV_OUT_ifc6 "../tv/rtldatafile/rtl.LINEAR.autotvout_ifc6.dat"
 parameter ifc6_ADDR_BITWIDTH = 32'd 64;
 parameter ifc6_AWUSER_BITWIDTH = 32'd 1;
 parameter ifc6_DATA_BITWIDTH = 32'd 128;
 parameter ifc6_WUSER_BITWIDTH = 32'd 1;
 parameter ifc6_ID_BITWIDTH = 32'd 1;
 parameter ifc6_RUSER_BITWIDTH = 32'd 1;
 parameter ifc6_BUSER_BITWIDTH = 32'd 1;
 parameter   FIFO_DEPTH            =   1 + 1;
 parameter   mem_page_num            =   32'd 4;
 parameter   FIFO_DEPTH_ADDR_WIDTH   =    32'd 32;
parameter ifc6_C_DATA_BITWIDTH = 32'd 128;
parameter ifc6_mem_depth = 32'd 512512;
parameter ReadReqLatency = 32'd 1;
parameter WriteReqLatency = 32'd 1;
// Input and Output
input clk;
input reset;
input  TRAN_ifc6_AWVALID;
output  TRAN_ifc6_AWREADY;
input [ifc6_ADDR_BITWIDTH - 1 : 0] TRAN_ifc6_AWADDR;
input [ifc6_ID_BITWIDTH - 1 : 0] TRAN_ifc6_AWID;
input [8 - 1 : 0] TRAN_ifc6_AWLEN;
input [3 - 1 : 0] TRAN_ifc6_AWSIZE;
input [2 - 1 : 0] TRAN_ifc6_AWBURST;
input [2 - 1 : 0] TRAN_ifc6_AWLOCK;
input [4 - 1 : 0] TRAN_ifc6_AWCACHE;
input [3 - 1 : 0] TRAN_ifc6_AWPROT;
input [4 - 1 : 0] TRAN_ifc6_AWQOS;
input [4 - 1 : 0] TRAN_ifc6_AWREGION;
input [ifc6_AWUSER_BITWIDTH - 1 : 0] TRAN_ifc6_AWUSER;
input  TRAN_ifc6_WVALID;
output  TRAN_ifc6_WREADY;
input [ifc6_DATA_BITWIDTH - 1 : 0] TRAN_ifc6_WDATA;
input [ifc6_DATA_BITWIDTH/8 - 1 : 0] TRAN_ifc6_WSTRB;
input  TRAN_ifc6_WLAST;
input  TRAN_ifc6_WID;
input [ifc6_WUSER_BITWIDTH - 1 : 0] TRAN_ifc6_WUSER;
input  TRAN_ifc6_ARVALID;
output  TRAN_ifc6_ARREADY;
input [ifc6_ADDR_BITWIDTH - 1 : 0] TRAN_ifc6_ARADDR;
input [ifc6_ID_BITWIDTH - 1 : 0] TRAN_ifc6_ARID;
input [8 - 1 : 0] TRAN_ifc6_ARLEN;
input [3 - 1 : 0] TRAN_ifc6_ARSIZE;
input [2 - 1 : 0] TRAN_ifc6_ARBURST;
input [2 - 1 : 0] TRAN_ifc6_ARLOCK;
input [4 - 1 : 0] TRAN_ifc6_ARCACHE;
input [3 - 1 : 0] TRAN_ifc6_ARPROT;
input [4 - 1 : 0] TRAN_ifc6_ARQOS;
input [4 - 1 : 0] TRAN_ifc6_ARREGION;
input  TRAN_ifc6_ARUSER;
output  TRAN_ifc6_RVALID;
input  TRAN_ifc6_RREADY;
output [ifc6_DATA_BITWIDTH - 1 : 0] TRAN_ifc6_RDATA;
output  TRAN_ifc6_RLAST;
output [ifc6_ID_BITWIDTH - 1 : 0] TRAN_ifc6_RID;
output [ifc6_RUSER_BITWIDTH - 1 : 0] TRAN_ifc6_RUSER;
output [2 - 1 : 0] TRAN_ifc6_RRESP;
output  TRAN_ifc6_BVALID;
input  TRAN_ifc6_BREADY;
output [2 - 1 : 0] TRAN_ifc6_BRESP;
output [ifc6_ID_BITWIDTH - 1 : 0] TRAN_ifc6_BID;
output [ifc6_BUSER_BITWIDTH - 1 : 0] TRAN_ifc6_BUSER;
input ready;
input done;

// Inner signals
// AW request fifo
reg    [ifc6_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [ifc6_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR_tmp; 
...
// AR request fifo
reg    [ifc6_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [ifc6_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR_tmp; 
...
// WDATA fifo
reg    [ifc6_DATA_BITWIDTH - 1 : 0]         FIFO_WDATA           [0 : FIFO_DEPTH - 1]; 
reg    [ifc6_DATA_BITWIDTH/8 - 1 : 0]       FIFO_WSTRB           [0 : FIFO_DEPTH - 1]; 
...
reg [ifc6_DATA_BITWIDTH - 1:0] RDATA_tmp = 0;
reg [2 - 1:0] RRESP_tmp = 0;
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [ifc6_DATA_BITWIDTH - 1 : 0] ifc6_mem_0 [0: ifc6_mem_depth - 1] = '{default : 'h0}; 
reg [ifc6_DATA_BITWIDTH - 1 : 0] ifc6_mem_1 [0: ifc6_mem_depth - 1] = '{default : 'h0}; 
reg [ifc6_DATA_BITWIDTH - 1 : 0] ifc6_mem_2 [0: ifc6_mem_depth - 1] = '{default : 'h0}; 
reg [ifc6_DATA_BITWIDTH - 1 : 0] ifc6_mem_3 [0: ifc6_mem_depth - 1] = '{default : 'h0}; 
reg [31 : 0] clk_counter ;
reg [31 : 0] current_AW_req_transaction = 0 ;
reg [31 : 0] current_AR_req_transaction = -1 ;
reg write_processing = 0;
reg [ifc6_ADDR_BITWIDTH - 1 : 0] wr_processing_addr = 0;
reg [ifc6_ADDR_BITWIDTH - 1 : 0] rd_processing_addr = 0;
reg [31 : 0] wr_processing_trans_num = 0;
reg [ifc6_DATA_BITWIDTH - 1 : 0] wr_processing_data = 0;
assign TRAN_ifc6_AWREADY    =    !FIFO_AW_req_full; 
assign TRAN_ifc6_ARREADY    =    !FIFO_AR_req_full; 
assign TRAN_ifc6_WREADY    =     !(FIFO_WDATA_req_full || FIFO_WDATA_size_full); 
assign TRAN_ifc6_BVALID = (BRESP_counter == 0) ? 0 : 1;
assign TRAN_ifc6_BRESP = BRESP_tmp;
assign TRAN_ifc6_RDATA = RDATA_tmp;
assign TRAN_ifc6_RRESP = RRESP_tmp;
assign TRAN_ifc6_RLAST = RLAST_tmp;
assign TRAN_ifc6_RVALID = RVALID_tmp;

initial begin : initialize_offset
  integer DATA_byte_num; 
  integer c_bitwidth;
  DATA_byte_num = 0; 
  c_bitwidth = ifc6_C_DATA_BITWIDTH;
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_ifc6_AWREADY & TRAN_ifc6_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            FIFO_AW_req_SIZE [FIFO_AW_req_ptr_w]    =   TRAN_ifc6_AWSIZE; 
            FIFO_AW_req_ADDR [FIFO_AW_req_ptr_w]    =   TRAN_ifc6_AWADDR; 
            FIFO_AW_req_LEN  [FIFO_AW_req_ptr_w]    =   TRAN_ifc6_AWLEN; 
            FIFO_AW_req_BURST[FIFO_AW_req_ptr_w]    =   TRAN_ifc6_AWBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_ifc6_ARREADY & TRAN_ifc6_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            FIFO_AR_req_SIZE [FIFO_AR_req_ptr_w]    =   TRAN_ifc6_ARSIZE; 
            FIFO_AR_req_ADDR [FIFO_AR_req_ptr_w]    =   TRAN_ifc6_ARADDR; 
            FIFO_AR_req_LEN  [FIFO_AR_req_ptr_w]    =   TRAN_ifc6_ARLEN; 
            FIFO_AR_req_BURST[FIFO_AR_req_ptr_w]    =   TRAN_ifc6_ARBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_ifc6_WREADY & TRAN_ifc6_WVALID) begin    // RTL is sending a WDATA data 
            FIFO_WDATA [FIFO_WDATA_req_ptr_w]    <=   TRAN_ifc6_WDATA; 
            FIFO_WSTRB [FIFO_WDATA_req_ptr_w]    <=   TRAN_ifc6_WSTRB; 
            if(FIFO_WDATA_req_ptr_w != FIFO_DEPTH - 1) 
                FIFO_WDATA_req_ptr_w <= FIFO_WDATA_req_ptr_w + 1; 
            else 
                FIFO_WDATA_req_ptr_w <= 0; 
            if (TRAN_ifc6_WLAST == 1 ) begin
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_ifc6_AWVALID && TRAN_ifc6_AWREADY && ((FIFO_AW_req_ptr_w - FIFO_AW_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AW_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_ifc6_ARVALID && TRAN_ifc6_ARREADY && ((FIFO_AR_req_ptr_w - FIFO_AR_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AR_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_ifc6_WVALID && TRAN_ifc6_WREADY && ((FIFO_WDATA_req_ptr_w - FIFO_WDATA_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_ifc6_WVALID && TRAN_ifc6_WREADY && TRAN_ifc6_WLAST && ((FIFO_WDATA_size_ptr_w - FIFO_WDATA_size_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if ( send_one_BRESP == 'b1 && !(BRESP_counter != 32'h0 && TRAN_ifc6_BREADY) ) begin
            BRESP_counter <= BRESP_counter + 1;
        end else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_ifc6_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
...
initial begin : AW_request_proc
    ...
    reg [ifc6_DATA_BITWIDTH - 1 : 0] FIFO_WDATA_tmp;
    reg [ifc6_DATA_BITWIDTH - 1 : 0] WDATA_tmp;
    reg [ifc6_DATA_BITWIDTH/8 - 1 : 0] FIFO_WSTRB_tmp;
    @(posedge clk);
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > ifc6_mem_depth) begin
                $display ("/nethome/zchen752/Linear/fc_layer/solution1/sim/verilog/AESL_axi_master_ifc6.v: Write request address %d exceed AXI master ifc6 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, ifc6_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AW_req_BURST_tmp === 1) begin
                ...
                while (counter != output_length + 1) begin
                    if (FIFO_WDATA_req_empty != 1) begin 
                            ...
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = ifc6_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        1 : WDATA_tmp[j] = ifc6_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        2 : WDATA_tmp[j] = ifc6_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        3 : WDATA_tmp[j] = ifc6_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                        ...
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : ifc6_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            1 : ifc6_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            2 : ifc6_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            3 : ifc6_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
                    ...
                    if (FIFO_WDATA_req_empty != 1) begin 
                        ...
                        for (i = 0 ; i < data_byte_size; i = i + 1) begin
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = ifc6_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        1 : WDATA_tmp[j] = ifc6_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        2 : WDATA_tmp[j] = ifc6_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        3 : WDATA_tmp[j] = ifc6_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        default: $display("The page_num of AXI write is not valid!");
                                    endcase
                                end
                            end
                        ...
                        wr_processing_data = WDATA_tmp;
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : ifc6_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            1 : ifc6_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            2 : ifc6_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            3 : ifc6_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
...
initial begin : AR_request_proc
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > ifc6_mem_depth) begin
                $display ("/nethome/zchen752/Linear/fc_layer/solution1/sim/verilog/AESL_axi_master_ifc6.v: Read request address %d exceed AXI master ifc6 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, ifc6_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AR_req_BURST_tmp === 1) begin
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= ifc6_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            1 : RDATA_tmp <= ifc6_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            2 : RDATA_tmp <= ifc6_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            3 : RDATA_tmp <= ifc6_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                    ...
                    @(posedge clk);
                    if (RVALID_tmp && TRAN_ifc6_RREADY) begin
                        counter = counter + 1;
                    end 
                end
                RVALID_tmp <= 0;
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= ifc6_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            1 : RDATA_tmp <= ifc6_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            2 : RDATA_tmp <= ifc6_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            3 : RDATA_tmp <= ifc6_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            default: $display("The page_num of AXI read is not valid!");
                        endcase
                    RVALID_tmp <= 1;
                    RRESP_tmp <= 0;
...
initial begin : read_file_process 
  ...
  integer mem_page; 
  integer ifc6_bitwidth; 
  reg [279 : 0] token; 
  reg [279 : 0] token_tmp; 
  //reg [ifc6_C_DATA_BITWIDTH - 1 : 0] token_tmp; 
  reg [ifc6_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  integer i; 
  transaction_num = 0;
  ifc6_bitwidth = ifc6_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (ifc6_bitwidth , factor);
  fp = $fopen(`TV_IN_ifc6,"r"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_ifc6); 
      $finish; 
  end 
  token = read_token(fp); 
  ...
  while (token != "[[[/runtime]]]") begin 
      ...
      mem_tmp [ifc6_DATA_BITWIDTH - 1: 0] = 0;
      for(i = 0; i < ifc6_mem_depth; i = i + 1) begin 
          token = read_token(fp);
          ...
          if (factor == 4) begin
              ...
              if (i%factor == 3) begin
                  ...
                  case(mem_page)
                      0 : ifc6_mem_0[i/factor] = mem_tmp;
                      1 : ifc6_mem_1[i/factor] = mem_tmp;
                      2 : ifc6_mem_2[i/factor] = mem_tmp;
                      3 : ifc6_mem_3[i/factor] = mem_tmp;
          ...
          if (factor == 1) begin
              mem_tmp = token_tmp;
              case(mem_page)
                  0 : ifc6_mem_0[i] = mem_tmp;
                  1 : ifc6_mem_1[i] = mem_tmp;
                  2 : ifc6_mem_2[i] = mem_tmp;
                  3 : ifc6_mem_3[i] = mem_tmp;
                  default: $display("The page_num of read file is not valid!");
              endcase
              mem_tmp [ifc6_DATA_BITWIDTH - 1: 0] = 0;
          end
