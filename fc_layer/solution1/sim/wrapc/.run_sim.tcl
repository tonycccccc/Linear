...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /tools/software/xilinx/Vitis_HLS/2021.1/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /tools/software/xilinx/Vitis_HLS/2021.1/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /tools/software/xilinx/Vitis_HLS/2021.1/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /tools/software/xilinx/Vitis_HLS/2021.1/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "LINEAR.autotvin.dat"
	set constFileTvOut       "LINEAR.autotvout.dat"
	set constFileHdlTvIn     "LINEAR.autohdltvin.dat"
	set constFileHdlTvOut    "LINEAR.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
